...
ResumeButton.prototype.controlText_ = 'Reprendre';
...
ResumeButton.prototype.controlText_ = 'Débuter';
...
var ModalButtons = (function (_Component) {
  ...
  function ModalButtons(player, options) {
    ...
    new _get(Object.getPrototypeOf(ModalButtons.prototype), 'constructor', this).call(this, player, options);
...
var ResumeModal = (function (_ModalDialog) {
  ...
  function ResumeModal(player, options) {
    ...
    new _get(Object.getPrototypeOf(ResumeModal.prototype), 'constructor', this).call(this, player, options);
...
var Resume = function Resume(options) {
  ...
  var title = options.title || 'Reprendre où vous en étiez ?';
  var resumeButtonText = options.resumeButtonText || 'Reprendre';
  var cancelButtonText = options.cancelButtonText || 'Débuter';
